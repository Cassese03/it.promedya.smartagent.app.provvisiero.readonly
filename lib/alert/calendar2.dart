...
///    [CalendarDatePickerByLorenzo] and provides an optional compact view where the
///    user can enter a date as a line of text.
///  * [showTimePicker], which shows a dialog that contains a Material Design
///    time picker.
///
class CalendarDatePickerByLorenzo extends StatefulWidget {
  ...
  @override
  State<CalendarDatePickerByLorenzo> createState() =>
      _CalendarDatePickerByLorenzoState();
}

class _CalendarDatePickerByLorenzoState
    extends State<CalendarDatePickerByLorenzo> {
  ...
  @override
  void didUpdateWidget(CalendarDatePickerByLorenzo oldWidget) {
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        widget.days?.forEach((element) {
          if (element["datadoc"] != null && element["datadoc"] != "null") {
            var datadoc = intl.DateFormat("yyyy-MM-dd hh:mm:ss")
                .parse(element["datadoc"]);
            if (dayToBuild.difference(datadoc) == const Duration(days: 0)) {
              dayColor = Colors.red;
              decoration = BoxDecoration(
          ...
          if (element["dataconsegna"] != null &&
              element["dataconsegna"] != "null") {
            var dataconsegna = intl.DateFormat("yyyy-MM-dd hh:mm:ss")
                .parse(element["dataconsegna"]);

            if (dayToBuild.difference(dataconsegna) ==
        ...
        // widget per creazione singolo giorno
...
/// [CalendarDatePickerByLorenzo], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [CalendarDatePickerByLorenzo], which provides a Material Design date picker
///    interface.
///
