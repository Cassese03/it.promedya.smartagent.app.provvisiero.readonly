...
import 'package:provvisiero_readonly/alert/calendar2.dart';
...
///
Future<DateTime?> showDatePickerByLorenzo({
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    CalendarDatePickerByLorenzo calendarDatePicker() {
      return CalendarDatePickerByLorenzo(
    ...
    final Widget header = _DatePickerHeader(
      helpText: "Settimana - ${_selectedDate.value.weekOfYear.toString()} ",
      titleText: dateText,
